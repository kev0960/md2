...
bool CppSyntaxHighlighter::ParseCode() {
...
size_t CppSyntaxHighlighter::HandleStringLiteral(size_t string_literal_start) {
...
size_t CppSyntaxHighlighter::HandleMacro(size_t macro_start) {
  // Find the delimiter.
...
void CppSyntaxHighlighter::AppendCurrentToken(SyntaxTokenType current_token,
                                              size_t token_start,
                                              size_t token_end) {
  if (current_token == IDENTIFIER) {
