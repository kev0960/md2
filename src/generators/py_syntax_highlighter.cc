...
bool PySyntaxHighlighter::ParseCode() {
...
size_t PySyntaxHighlighter::HandleStringLiteral(size_t string_literal_start) {
...
void PySyntaxHighlighter::AppendCurrentToken(SyntaxTokenType current_token,
                                             size_t token_start,
                                             size_t token_end) {
  if (current_token == IDENTIFIER) {
